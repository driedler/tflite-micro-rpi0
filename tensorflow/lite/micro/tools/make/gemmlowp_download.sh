...
DOWNLOADED_FLATBUFFERS_PATH=${DOWNLOADS_DIR}/gemmlowp

if [ -d ${DOWNLOADED_FLATBUFFERS_PATH} ]; then
  echo >&2 "${DOWNLOADED_FLATBUFFERS_PATH} already exists, skipping the download."
else
  ZIP_PREFIX="719139ce755a0f31cbf1c37f7f98adcc7fc9f425"
  FLATBUFFERS_URL="https://github.com/google/gemmlowp/archive/${ZIP_PREFIX}.zip"
  FLATBUFFERS_MD5="7e8191b24853d75de2af87622ad293ba"
  ...
  mv "${TEMPDIR}/gemmlowp-${ZIP_PREFIX}" ${DOWNLOADED_FLATBUFFERS_PATH}
  rm -rf "${TEMPDIR}"
